...
<body>
<div align="center"><font size="+2">We offer optimised sip account for our products with best quality and rates</font><br />
<font size="+1" color="#FF0000">Prices are in &euro; cents</font></div>
<?
echo '<div align="center">'.translate("Q").' | <a href="index.php">'.translate("linkmyaccount").'</a> | 
<a href="contactct.php">'.translate("mycreateaccount").'</a><br/>';
################### select form ###########################		
echo '<form name="Myselect" action="'.$_SERVER['PHP_SELF'].'?sort=" method="get">';
$sel = mysql_query("SELECT comment , pattern FROM ".ASTCC.".routes");
echo 'Search here a Country by name or prefix <input type="texte" name="letter" />';
