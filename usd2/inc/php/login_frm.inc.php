...
<div style="text-align:center;"><a class="big_links" href="<?=$_SERVER['PHP_SELF'];?>?logout=1"><img src="imgs/gimmics/logoff.gif" width="50" height="50" border="0" alt="Logout" title="Logout" /></a></div>
<?php
}
?>
