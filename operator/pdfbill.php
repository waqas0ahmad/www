...
<?php
		...
		$TVa = explode(".",$tva); $TVa = $TVa[1] ; if (strlen($TVa) == '1'){ $TVa = $TVa.'0';}
	?>
	<br/>
	...
	<tr>
		<td width="320"><br/><?=FIRMENNAME?><br/><?=FIRMENSTRASSE?> <?=PLZ?> <?=ORT?> <?=LAND?><br/>  <?=UMSATZSTEUERNR?>		</td>
		<td></td>
		<td></td>
		<td></td>
		<td align="right"><? echo translate("vat").' '.$TVa.'%';  ?> <br/>TTC <? echo ''.$devise.''; ?> </td>
