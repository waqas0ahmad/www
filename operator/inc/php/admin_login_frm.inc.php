...
if ($angemeldet == 0)
	{
	echo'<form name="formSaisie" action="'.$_SERVER['PHP_SELF'].'" method="post">
	...
	if($aAdmin[0]['admin_status'] == 1)
		{
		echo'<div style="color:green;">&nbsp;&nbsp;&nbsp;&nbsp;'.translate("masteradmin").'</div><br />
			<div style="color:green;">&nbsp;&nbsp;&nbsp;&nbsp;'.translate("loginsuccess").'</div><br />';
		}
	else
		{
		echo'<div style="color:green;">&nbsp;&nbsp;&nbsp;&nbsp;'.translate("regularadmin").'</div><br />
			<div style="color:green;">&nbsp;&nbsp;&nbsp;&nbsp;'.translate("loginsuccess").'</div><br />';
		}
	echo'<div><form><input type="button"  class="logof" value="&nbsp;&nbsp;&nbsp;&nbsp;" OnClick="window.location.href=\''.$_SERVER['PHP_SELF'].'?logout=1\'"></form></div>';
}
?>
