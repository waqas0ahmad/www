...
$i18n['supportrecommends']= 'Le support de Systempay recommande fortement de lire la documentation';

/**
 * html form
 */
$i18n['payzensolution'] = 'EXEMPLE D\'IMPLEMENTATION DE LA SOLUTION DE PAIEMENT Systempay';
$i18n['info'] = 'INFORMATIONS';
$i18n['usesform'] = 'Le paiement s\'appuie sur l\'envoi d\'un formulaire de paiement en https vers l\'URL de la plateforme de paiement Systempay.';
$i18n['file'] = 'Fichier ';
$i18n['htmlformuse'] = '<p>Le fichier <code>html-form.php</code> envoie l\'ensemble des champs liés au paiement vers le fichier <code>form-tunnel.php</code> qui récupère l\'ensemble des ces champs pour construire la requête de paiement.</p><p>Les champs sont renseignés à titre d\'exemple, à votre charge de les valoriser en fonction de votre contexte.</p><p><b>D\'autres champs sont disponibles, le support Systempay vous invite à lire la documentation liée au formulaire de paiement</b> <a href="https://paiement.systempay.fr/doc/">Consulter la documentation.</a></p>';
