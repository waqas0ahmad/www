<?php
$i18n = array();
$i18n['starterkit']= 'A starter kit with your Systempay Payment Form';
...
$i18n['supportrecommends']= 'The Systempay support recommends to read the settings analysis documentation on';

/**
 * html form
 */
$i18n['payzensolution'] = 'Systempay PAYMENT SOLUTION IMPLEMENTATION EXAMPLE';
$i18n['info'] = 'INFORMATIONS';
$i18n['usesform'] = 'The payment uses the sending of a payment form to Systempay payment gateway URL.';
$i18n['file'] = 'File';
$i18n['htmlformuse'] = 'the file <code>html-form.php</code> sends these payment fields to the<code>form-tunnel.php</code>  which fetch these fields to create the payment request.</p><p>These fields are filled with examples, it is up to you to fill them depending on your context and configuration.</p><p><b>Some other fields are available, Systempay support recommends to read the payment form documentation</b> <a href="https://paiement.systempay.fr/doc/">Read the documentation.</a>';
