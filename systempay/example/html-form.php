...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $site_url; ?>">Systempay</a>
        </div>
...
<form style="margin-top:10px;" method="POST" action="form-tunnel.php">
    <table class="table table-bordered">
        ...
        <tr>
            <td class="field_mandatory text-danger"><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-amount.html">vads_amount</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-order-id.html">vads_order_id</a></td>
            <td><input type="text" class="form-control" name="vads_order_id" value="123456" size="20"></td>
            <td><?php echo $i18n['orderdesc']; ?></td>
        </tr>

        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-id.html">vads_cust_id</a></td>
            <td><input type="text" class="form-control" name="vads_cust_id" value="2380" size="20"></td>
            <td class="text-right"><?php echo $i18n['custid']; ?></td>
        </tr>
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-name.html">vads_cust_name</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-address.html">vads_cust_address</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-zip.html">vads_cust_zip</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-city.html">vads_cust_city</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-country.html">vads_cust_country</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-phone.html">vads_cust_phone</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-cust-email.html">vads_cust_email</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-url-return.html">vads_url_return</a></td>
        ...
        <tr>
            <td><a target="_blank" href="https://paiement.systempay.fr/doc/<?php echo $lang_doc; ?>/form-payment/standard-payment/vads-redirect-success-timeout.html">vads_redirect_success_timeout</a></td>
